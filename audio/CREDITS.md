...
| `step_grass.ogg`, `step_stone.ogg`, `whoosh2.ogg`, `explosion.ogg` | **Kenney** (RPG Audio / Sci-Fi Sounds / Digital Audio) — via GDQuest *Node Essentials* | **CC0** | none required (Kenney — https://kenney.nl — credit appreciated) |
